...
export function Loader({ text = 'Loading, please wait' }: Props) {
    return (
        <div className="common--loader__container">
            <div className="loader-animation">
                <svg version="1.1" className="sun" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enableBackground="new 0 0 10 10">
                    <g>
                ...
                <svg version="1.1" className="cloud" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="10px" height="10px" viewBox="0 0 10 10" enableBackground="new 0 0 10 10">
